...
RUN python -m pip install --no-cache-dir paddlepaddle==3.0.0 -f https://www.paddlepaddle.org.cn/whl/linux/mkl/noavx/stable.html
...
# Instalar dependencias adicionales que pueda necesitar omnimrz
